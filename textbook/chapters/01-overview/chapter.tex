...
The theory track moves through the thirteen chapters of this book at
roughly one chapter per week, with Chapters~2 and~3 paired in Week~2.
The lab track runs the \textbf{seven-stage Prototype Development Cycle},
\index{seven-stage workflow}
which you will study in depth in Chapter~2.
...
\medskip
\noindent\textbf{Up next:} Chapter~2 introduces the \textbf{seven-stage
Prototype Development Cycle} in full.
You will see exactly how each stage builds on the previous one, why
prototypes answer questions rather than produce things, and how to
choose the fidelity level that matches the question at hand---without
wasting effort on features the question does not require.
