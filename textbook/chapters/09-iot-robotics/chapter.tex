...
The calculations below are the deliverables; the design records that carry them
are what Gate~4 reviewers will audit.
...
\begin{enumerate}
  ...
  \item \textit{Safety design decisions} --- e-stop type, location, and wiring
        ...
        load-bearing elements, with the cross-section area and material data cited.
\end{enumerate}
